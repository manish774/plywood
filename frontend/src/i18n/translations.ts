  ...
  nav: {
    ...
    home: {
      ...
      banners: [
        ...
        {
          eyebrow: "Space-saving core",
          title: "Block board built for wardrobes",
          subtitle: "Lightweight wood-strip core panels for shutters, lofts and long spans without the weight of solid ply.",
          cta: "Browse categories",
        },
        {
          eyebrow: "Ready to hang",
          title: "Flush doors, factory-finished",
          subtitle: "Laminate and veneer finishes on a solid core — hinge them straight out of the crate.",
          cta: "Browse categories",
        },
        {
          eyebrow: "Sunmica-style finishes",
          title: "Laminates in glossy, matte and textured",
          subtitle: "Dress up wardrobes, cabinets and counters without the cost of solid wood.",
          cta: "Browse categories",
        },
      ],
    ...
    admin: {
      ...
      festivalThemeLabel: "Festival theme",
      festivalThemeHint: "Applies a decorative theme site-wide for every visitor during the festival season.",
      festivalThemeNone: "None (default)",
...
const hi: TranslationDict = {
  nav: {
    ...
    common: {
      ...
      viewLargerImage: "बड़ी तस्वीर देखें",
    ...
    home: {
      ...
      banners: [
        ...
        {
          eyebrow: "जगह बचाने वाला कोर",
          title: "वॉर्डरोब के लिए बना ब्लॉक बोर्ड",
          subtitle: "शटर, लॉफ्ट और लंबे पैनल के लिए हल्के वुड-स्ट्रिप कोर बोर्ड — सॉलिड प्लाई जितना वज़न नहीं।",
          cta: "कैटेगरी देखें",
        },
        {
          eyebrow: "टांगने के लिए तैयार",
          title: "फ्लश डोर, फैक्ट्री-फिनिश्ड",
          subtitle: "सॉलिड कोर पर लैमिनेट और वीनियर फिनिश — क्रेट से निकालते ही लगा दें।",
          cta: "कैटेगरी देखें",
        },
        {
          eyebrow: "सनमाइका जैसी फिनिश",
          title: "ग्लॉसी, मैट और टेक्सचर्ड लैमिनेट्स",
          subtitle: "वॉर्डरोब, कैबिनेट और काउंटर को ठोस लकड़ी की कीमत के बिना सजाएं।",
          cta: "कैटेगरी देखें",
        },
      ],
    ...
    admin: {
      ...
      festivalThemeLabel: "त्योहार थीम",
      festivalThemeHint: "त्योहार के मौसम में सभी विज़िटर्स के लिए पूरी वेबसाइट पर एक सजावटी थीम लागू होती है।",
      festivalThemeNone: "कोई नहीं (डिफ़ॉल्ट)",
